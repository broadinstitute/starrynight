...
class SBSApplyIllumInvokeCPModule(StarrynightModule):
    ...
    def _spec(self) -> SpecContainer:
        ...
        return SpecContainer(
            ...
            outputs={
                "corrected_images_path": TypeOutput(
            ...
            citations=TypeCitations(
                algorithm=[
                    TypeAlgorithmFromCitation(
                        name="Starrynight SBS illum apply invoke cellprofiler module",
                        description="This module invoke cellprofiler for applying cp illumination apply.",
                    )
                ]
            ),
        )
    ...
    def _create_pipe(self) -> Pipeline:
        ...
        cmd = [
            ...
            "-o",
            spec.outputs["corrected_images_path"].value,
            "--sbs",
        ]
