...
1. Pipeline-specific validations defined by configuration
2. Dynamic column group validation based on naming patterns
3. Extensible SQL-based custom checks
"""
