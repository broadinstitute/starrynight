...
Usage:
    uv run pytest -xvs fixtures/basic_setup/generate_fixtures.py
"""
...
@pytest.mark.skip(reason="Only run manually to regenerate fixtures")
...
pytestmark = pytest.mark.parametrize("fix_starrynight_setup", ["generated"], indirect=True)