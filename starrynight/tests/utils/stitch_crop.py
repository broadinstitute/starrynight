...
if os.path.isdir(subdir):
        ...
        if round_or_square == 'square':
                ...
                for eachwell in welllist:
                        # simplified for test
                        standard_grid_instructions=["type=[Grid: row-by-row] order=[Right & Down                ] grid_size_x="+rows+" grid_size_y="+columns+" tile_overlap="+overlap_pct+" first_file_index_i=0 directory="+subdir+" file_names=",
